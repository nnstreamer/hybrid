module github.com/nnstreamer/hybrid/client/cli/fake-attestation

go 1.25.4

require github.com/openpcc/openpcc v0.0.80
...
require (
	...
	github.com/allaboutapps/integresql-client-go v1.0.0 // indirect
	...
	github.com/openpcc/ohttp v0.0.80 // indirect
